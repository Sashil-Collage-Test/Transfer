def calculate_metrics(retrieved_set,relevant_set):
    ...
    false_negative=len(relevant_set.difference(retrived_set))
...
retrived_set={"doc1","doc2","doc3"}
relevant_set={"doc1","doc4"}

precision,recall,f_measure=calculate_metrics(retrived_set,relevant_set)
